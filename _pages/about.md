...
> I love tackling tough engineering problems with moving parts, fluids, and heat transfer. From hypersonic flight to power generation, I enjoy diving deep into the maths and physics to find solutions that work for industry and push the boundaries of existing technology.

Currently a Research Fellow in the [Hypersonics and Rocketry Group](https://www.unisq.edu.au/research/institutes-centres/iaess/hypersonics-and-rocketry-group) at the University of Southern Queensland, I specialise in dynamical system analysis, state estimation, and optimisation. I hold a PhD from the University of Queensland and a Bachelor of Mechanical Engineering (Hons. I) from the University of Tasmania.

I've [collabroated with NASA](https://andrewjlock.github.io/projects/aerospace_imaging_and_diagnostics/) on re-entry capsule trajectory reconstruction, developed [stereoscopic model tracking](https://arc.aiaa.org/doi/10.2514/6.2023-3713) methods, researched [novel supercritical fluid power systems](https://andrewjlock.github.io/projects/sco2_cycle/), and developed efficient [simultanous hypersonic vehicle design and trajectory optimisation](http://0.0.0.0:8080/projects/hypersonic_vehicle_codesign/) frameworks. My work is [published](https://andrewjlock.github.io/publications/) in international journals, and has been presented at international conferences, the University of Oxford, and to many leading aerospace organisations. 
